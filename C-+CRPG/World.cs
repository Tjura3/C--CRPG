...
namespace C__CRPG
{
    ...
    public static class World
    {
        ...
        public static readonly List<Items> Item = new List<Items>();  //AHHH DUMb ITEMS = ITEM BRUUUUUHHHHH
        ...
        {
            Item.Add(new Weapon(ITEM_ID_RUSTY_SWORD, "Rusty sword", "Rusty swords", 0, 5));
            Item.Add(new Items(ITEM_ID_RAT_TAIL, "Rat tail", "Rat tails"));
            Item.Add(new Items(ITEM_ID_PIECE_OF_FUR, "Piece of fur", "Pieces of fur"));
            Item.Add(new Items(ITEM_ID_SNAKE_FANG, "Snake fang", "Snake fangs"));
            Item.Add(new Items(ITEM_ID_SNAKESKIN, "Snakeskin", "Snakeskins"));
            Item.Add(new Weapon(ITEM_ID_CLUB, "Club", "Clubs", 3, 10));
            Item.Add(new HealingPotion(ITEM_ID_HEALING_POTION, "Healing potion", "Healing potions", 5));
        ...
        private static void PopulateLocations()
        {
            ...
            alchemistHut.QuestAvalibleHere = QuestByID(QUEST_ID_CLEAR_ALCHEMIST_GARDEN);

            Location alchemistsGarden = new Location(LOCATION_ID_ALCHEMISTS_GARDEN, "Alchemist's garden", "Many plants are growing here.");
            alchemistsGarden.MonsterLivingHere = MonsterByID(MONSTER_ID_RAT);

            Location farmhouse = new Location(LOCATION_ID_FARMHOUSE, "Farmhouse", "There is a small farmhouse, with a farmer in front.");
            farmhouse.QuestAvalibleHere = QuestByID(QUEST_ID_CLEAR_FARMERS_FIELD);
